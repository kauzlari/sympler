...
#ifndef __F_PARTICLE_SCALAR_H
#define __F_PARTICLE_SCALAR_H
 ...
 */
class FParticleScalar : public FParticle
{
  protected:
  /*!
  ...
  /*!
     * The offset of the force on that scalar
   */
   ...
   */
    FParticleScalar(Simulation *simulation);

  /*!
     * Destructor
   */
    virtual ~FParticleScalar();
