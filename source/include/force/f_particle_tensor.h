...
#ifndef __F_PARTICLE_TENSOR_H
#define __F_PARTICLE_TENSOR_H
 ...
 */
class FParticleTensor : public FParticle
{
  protected:
  /*!
   ...
   */
    group_t groups;
      ...
      /*!
     * The name of the tensor this force acts on
       */
   ...
   */
    FParticleTensor(Simulation *simulation);

  /*!
     * Destructor
   */
    virtual ~FParticleTensor();
