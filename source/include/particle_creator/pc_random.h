...
#ifndef __PC_RANDOM_H
#define __PC_RANDOM_H
...
class ParticleCreatorRandom: public ParticleCreatorWithRngPCalc
{
protected:
  int m_nparticles;
  ...
  /* Store offset and size before other creators, like ParticleCreatorWall, can act */
...
public:
  ParticleCreatorRandom(Boundary *boundary);
