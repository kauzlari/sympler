...
#ifndef __GRID_METER_SCALAR_SUM_H
#define __GRID_METER_SCALAR_SUM_H 
 ...
 */
class GridMeterScalarSum: public GridMeter
{
protected:
  /*!
   * Tag offset of the scalar quantity
   */
  int m_scalar_o;

  /*!
   * Offset in the output data for the corresponding exponent
   */
  int m_exponent_o;
  ...
  /*!
   * The name of the scalar quantity
   */
...
public:
   ...
   */
  GridMeterScalarSum(GridAverager *averager);
