...
#ifndef __QUINTET_CALC_CURVATURE_F_H
#define __QUINTET_CALC_CURVATURE_F_H
 ...
 */
class QuintetCalcCurvatureF : public QuintetCalculator
{
protected:
...
*/
  ...
  */
   ...
   */
  virtual QuintetCalcCurvatureF* copyMySelf()
  {
    return new QuintetCalcCurvatureF(*this);
  }
 ...
 * Constructor
   */
  QuintetCalcCurvatureF(string symbol);
  
  /*!
   * Constructor
   */
  QuintetCalcCurvatureF(/*Node*/Simulation* parent);
   
  /*!
   * Destructor
   */
  virtual ~QuintetCalcCurvatureF() {
  }
