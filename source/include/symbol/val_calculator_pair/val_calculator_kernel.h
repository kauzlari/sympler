...
#ifndef __VAL_CALCULATOR_KERNEL_H
#define __VAL_CALCULATOR_KERNEL_H
...
/*!
 * Saves the evaluation of the interpolation function (the kernel) in each pair of particles
 */
class ValCalculatorKernel : public ValCalculatorPair
{
  protected:
    /*!
   ...
   */
    ...
    {
      return new ValCalculatorKernel(*this);
    }
   ...
   */
    ValCalculatorKernel(WeightingFunction *wf, string symbol);

  /*!
     * Constructor for Node hierarchy
   */
    ValCalculatorKernel(/*Node*/Simulation* parent);

  /*!
     * Destructor
   */
    virtual ~ValCalculatorKernel() {
    }
    ...
    */
    ...
    {
      point_t dummy = {{{0, 0, 0}}};
      pD->tag.doubleByOffset(m_slot) = m_wf->interpolate(pD, dummy, NULL);
    }
