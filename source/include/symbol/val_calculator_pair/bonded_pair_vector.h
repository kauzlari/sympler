...
#ifndef __BONDED_PAIR_VECTOR_H_
#define __BONDED_PAIR_VECTOR_H_
...
/*! Module for calculation of a vectorial Symbol stored in a pair*/

class BondedPairVector : public BondedPairArbitrary {
  
 protected:
  
  virtual ValCalculatorPair* copyMySelf() {
    return new BondedPairVector(*this);
  }
 ...
 public:
   ...
   */
  BondedPairVector(/*Node*/Simulation* parent);
  
  /*!
   * Destructor//
   */
  virtual ~BondedPairVector();
...
/*       m_function(&temp, dis); */
    ...
    m_function(&(dis->tag.pointByOffset(m_slot)), dis);
