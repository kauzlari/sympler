...
public:
  ...
  // next not necessary because particles do not really move
  ...
  //  /*!
  //   * Checks which of the times (in the time vector) is the actual hit position. The function will be used in WallTriangle
  //   */
