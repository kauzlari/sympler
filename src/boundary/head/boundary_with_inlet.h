...
#ifndef __BOUNDARY_WITH_INLET_H
#define __BOUNDARY_WITH_INLET_H

#include "cell.h"
#include "boundary_arbitrary.h"

/*!
 * Description of a Boundary, having an inlet
 */
class BoundaryWithInlet: public BoundaryArbitrary
{
  protected:
  /*!
   ...
   */
    BoundaryWithInlet(Phase *phase);

  /*!
     * Destructor
   */
    virtual ~BoundaryWithInlet();
