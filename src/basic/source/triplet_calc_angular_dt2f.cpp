...
//   m_DtFname = "undefined";
  ...
  STRINGPC
      (forceSymbol, m_FinName,
       "Name of the symbol containing the precomputed force, which is used as input by this module.");
...
//     throw gError("TripletCalculator::setup", "Attribute 'dtFsymbol' undefined!");
  if(m_Dt2Fname == "undefined")
    throw gError("TripletCalculator::setup", "Attribute 'symbol2' undefined!");
