...
#ifndef __PAIR_VECTOR_H_
#define __PAIR_VECTOR_H_
...
/*! Module for calculation of a vector Symbol which is stored in each pair (within the cutoff).*/

class PairVector: public PairArbitrary {
