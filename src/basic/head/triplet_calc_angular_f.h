...
#ifndef __TRIPLET_CALC_ANGULAR_F_H
#define __TRIPLET_CALC_ANGULAR_F_H
 ...
 */
class TripletCalcAngularF : public TripletCalculator
{
protected:
  ...
  */
   ...
   */
  virtual TripletCalcAngularF* copyMySelf()
  {
    return new TripletCalcAngularF(*this);
  }
 ...
 * Constructor
   */
  TripletCalcAngularF(string symbol);
  
  /*!
   * Constructor
   */
  TripletCalcAngularF(/*Node*/Simulation* parent);
   
  /*!
   * Destructor
   */
  virtual ~TripletCalcAngularF() {
  }
