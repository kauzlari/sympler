...
#ifndef __TRIPLET_CALCULATOR_H
#define __TRIPLET_CALCULATOR_H
...
/*!
 * Parent class for a \a Symbol for cached properties computed during a loop over bonded triplets
 * NOTICE: This Calculator relies on convention 6 in the CONVENTIONS file
 */
class TripletCalculator : public Symbol
{
protected:
   ...
   */
     ...
     */
    size_t m_vector_slots[3];
#endif

  /*!
   * Species of the triplet particles. This relies on CONVENTION 6.
   */
  string m_species[3];

  /*!
   * Colour of first \a Particle in the triplets
   */
 ...
 * Constructor
   */
  TripletCalculator(string symbol);
  
  /*!
   * Constructor
   */
  TripletCalculator(/*Node*/Simulation* parent);
   
  /*!
   * Destructor
   */
  virtual ~TripletCalculator() {
  }
