...
#ifndef __TRIPLET_CALC_PART_SCALAR_H
#define __TRIPLET_CALC_PART_SCALAR_H
...
/*!
 * \a TripletCalculator for scalar cached properties computed during a loop 
 * over bonded triplets. This \a Symbol specifically caches a user-defined 
 * property depending on the cosine of triplet angle "cosa".
 */
class TripletCalcPartScalar : public TripletCalculator
{
protected:
  ...
  */
   ...
   */
  virtual TripletCalcPartScalar* copyMySelf() = 0;
 ...
 * Constructor
   */
  TripletCalcPartScalar(string symbol);
  
  /*!
   * Constructor
   */
  TripletCalcPartScalar(/*Node*/Simulation* parent);
   
  /*!
   * Destructor
   */
  virtual ~TripletCalcPartScalar() {
  }
   ...
   */
#ifndef _OPENMP
  virtual void compute(triplet_t* tr) = 0;
#else
  virtual void compute(triplet_t* tr/*, size_t thread_no*/ /*FIXME: parallelise!*/) = 0;
#endif
