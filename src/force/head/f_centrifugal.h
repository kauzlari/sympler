...
#ifndef __F_CENTRIFUGAL_H
#define __F_CENTRIFUGAL_H
...
/*!
 * Centrifugal force on each particle, i.e., f = w x w x r
 */
class FCentrifugal : public FParticle
{
protected:
  /*!
   * The center of rotation
   */
  point_t m_center_of_rotation;

  /*!
   * The rotation axis normalized to unity
   */
...
public:
   ...
   */
  FCentrifugal(Simulation *simulation);

  /*!
   * Destructor
   */
  virtual ~FCentrifugal();
