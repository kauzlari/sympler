...
#ifndef __F_PAIR_ARBITRARY_WF_H
#define __F_PAIR_ARBITRARY_WF_H
...
/*!
 * Base class for all pair forces.
 */
class FPairArbitraryWF : public FPairArbitrary
{
protected:
...
public:
   ...
   * Constructor
   */
  FPairArbitraryWF(Simulation *simulation);

  /*!
   * Destructor
   */
  virtual ~FPairArbitraryWF();
