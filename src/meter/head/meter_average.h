...
#ifndef __METER_AVERAGE_H
#define __METER_AVERAGE_H
...
/*!
 * Average quantities over the whole geometry
 */
class MeterAverage : public GridAverager
{
protected:
  /*!
   * The actual data
...
public:
   ...
   */
  MeterAverage(Simulation *simulation);

  /*!
   * Destructor
   */
  virtual ~MeterAverage();

  /*!
   * Calculate the total number of cells and the volume
   */
  virtual void setup();
