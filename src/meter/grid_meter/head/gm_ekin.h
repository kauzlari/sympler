...
#ifndef __GRID_METER_EKIN_H
#define __GRID_METER_EKIN_H
...
/*!
 * Determines the average kinetic energy per particle
 */
class GridMeterEKin: public GridMeter
{
 protected:
  /*!
 ...
 public:
   ...
   */
  GridMeterEKin(GridAverager *averager);
