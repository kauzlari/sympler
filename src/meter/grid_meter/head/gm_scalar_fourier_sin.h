...
#ifndef __GRID_METER_SCALAR_FOURIER_SIN_H
#define __GRID_METER_SCALAR_FOURIER_SIN_H 
 ...
 */
class GridMeterScalarFourierSin: public GridMeterScalar
{
protected:
...
public:
   ...
   */
  GridMeterScalarFourierSin(GridAverager *averager);
