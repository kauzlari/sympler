...
#ifndef __INTEGRATOR_TENSOR_H
#define __INTEGRATOR_TENSOR_H 
...
/*!
 * Simple Euler integration of a tensor field
 */
class IntegratorTensor: public Integrator
{
  protected:
  /*!
  ...
  /*!
     * The symbol (short name) of the tensor field
   */
    string m_tensor_symbol;

  /*!
     * The tag offset of the tensor field
   */
    size_t m_tensor_offset;

  /*!
     * The tag offsets of the force on this tensor field. Even though this integrator
   ...
   */
    IntegratorTensor(Controller *controller);

  /*!
     * Destructor
   */
    virtual ~IntegratorTensor();
  ...
  /*!
     * Return the name of the tensor field
   */
    virtual string tensorName() const {
  ...
  /*!
     * Return the tag offset of the tensor field
   */
    virtual size_t tensorOffset() const {
      return m_tensor_offset;
    }
