...
#ifndef __PCA_IAPWSIF97_KAPPA_TEST_H
#define __PCA_IAPWSIF97_KAPPA_TEST_H
...
class PCacheIAPWSIF97kappaTest : public PCacheIAPWSIF97TwoVarTest
{
  CPPUNIT_TEST_SUITE (PCacheIAPWSIF97kappaTest);
